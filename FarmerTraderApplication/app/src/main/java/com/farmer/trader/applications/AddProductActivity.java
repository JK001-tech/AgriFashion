...
public class AddProductActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (FromScreen.compareTo("FromUpdate") == 0) {
            ...
            if (MainProductType.compareTo("Fruits") == 0 || MainProductType.compareTo("Medicines") == 0 || MainProductType.compareTo("Machinery") == 0 ) {
...
//                    SubType = TypeSpinner.getSelectedItem().toString();
                ...
                if (temp[8].compareTo("Dozen")==0){
                    UnitSpinner.setSelection(0);

                }else if (temp[8].compareTo("Litre")==0){
                    UnitSpinner.setSelection(1);

                }else if (temp[8].compareTo("kilogram")==0){
                    UnitSpinner.setSelection(2);

                }else if (temp[8].compareTo("Number")==0){
