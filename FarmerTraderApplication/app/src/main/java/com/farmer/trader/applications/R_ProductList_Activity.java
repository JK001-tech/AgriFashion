    ...
    public void showFilterDialog() {
        ...
        if (ColumnName.compareTo("") == 0) {
            ...
            if (Clause.compareTo("ASC") == 0) {
                NameType.setImageResource(R.drawable.aesc_icon);

            } else {

                NameType.setImageResource(R.drawable.desc_icon);
            ...
            if (Clause.compareTo("ASC") == 0) {
                PriceType.setImageResource(R.drawable.aesc_icon);

            } else {
                PriceType.setImageResource(R.drawable.desc_icon);
